...
export class WebviewContentProvider {
    ...
    private renderFrames(frames: CodeFrame[]): string {
        return frames.map((frame, index) => this.renderFrame(frame, index)).join('');
    }

    private renderFrame(frame: CodeFrame, index: number): string {
    ...
    private renderFrameHeader(frame: CodeFrame, index: number): string {
        return `
    ...
    private renderSearchContainer(index: number): string {
